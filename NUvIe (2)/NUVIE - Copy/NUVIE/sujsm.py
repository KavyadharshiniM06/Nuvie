...
def get_movies_by_preferences(genre, min_rating):
    """Fetches movies based on selected genre and minimum rating from TMDb API."""
    genre_ids = ",".join(genre) if genre else None  
...
def submit():
    ...
    movies = get_movies_by_preferences(genre, min_rating)
